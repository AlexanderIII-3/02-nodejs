...
module.exports = (sequelize, DataTypes) => {
    class Doctor_Infor extends Model {
        ...
        static associate(models) {
            ...
            Doctor_Infor.belongsTo(models.History, { foreignKey: 'doctorId' })
            ...
            Doctor_Infor.hasMany(models.Booking, { foreignKey: 'doctorId', targetKey: 'doctorId', as: 'doctorInforData' })
